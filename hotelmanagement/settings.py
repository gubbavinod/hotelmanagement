...
SECRET_KEY = "django-insecure-kolv4y1-dp5v$7$ayn*dq*d-or&(#431mjf(%3$xztqmg24zn^"
...
LOGIN_URL = "/Hotel/login/"  # Your login URL
...
STATIC_URL = "static/"
STATICFILES_DIRS = [os.path.join(BASE_DIR, 'backendHotel/static')]
